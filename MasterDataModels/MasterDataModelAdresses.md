...
![Approach Modeling](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/masterdatamodel-procedure.png)
...
![Type of addresses](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/types-of-addresses.png)
...
![Typing of addresses](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/typing-of-addresses.png)
...
![Postal Address — All Components - diagram from UPU S42](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/postal_adress_diagram_upus42.png)
...
![Relationship person organization](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/use-case-relationship-person-organization.png)

The following diagram shows how the mapping of these entity relations can be realized in the data model:

![Relationship person organization](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/ER-Persons-relations-organizations.png)

##### 4.2.4.2 Organization to organization

![Relations of organizations](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/relations-of-organizations.png)

The following diagram shows how the mapping of these entity relations can be realized in the data model:

![Relations of organizations](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/ER-organizations-relations-organizations.png)

##### 4.2.4.3 Person to person

![Relations of organizations](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/relations-among-persons.png)

The following diagram shows how the mapping of these entity relations can be realized in the data model:

![Relations of organizations](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/ER-Persons-relations-persons.png)
...
![UML Draf OIH Master Data Model Addresses](https://github
.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/Assets/OIHDataModelAdressesUML.png)

[JSON Schema for organizations](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/organization.json)

[JSON Schema for persons](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/person.json)

[JSON Schema for relations](https://github.com/openintegrationhub/Data-and-Domain-Models/blob/master/MasterDataModels/relation.json)
